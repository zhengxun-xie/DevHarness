// Vendored verbatim (Apache-2.0) from shared/client/body-mutations.ts of
// @linxin666/dsh-client-ui-task-board v0.3.22 (the generated sync-shared copy
// also used by dsh-ssh). Symbol.for hub keys stay identical so every family
// plugin on the page shares one MutationObserver. Do not rename the symbols.
/**
