/**
 * Browser half entry: register the DevBuddy Reviewer as a right-Sidebar
...
export const REVIEWER_ID = 'dsh-devbuddy-reviewer'

declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    /** DevBuddy Reviewer panel copy. */
    devBuddyReviewer: ReviewerKey
  }
}

declare module '@deepseek-ai/dsh-client-ui-sidebar-right/client' {
  interface SidebarRightTabParamsMap {
    'devbuddy-reviewer': ReviewerTabParams
  }
}
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(
    ...
    'dsh-devbuddy-reviewer: dictionaries',
  )
  ctx.effect(
    () => ctx.sidebarRightTabs.register(reviewerDefinition(t)),
    'dsh-devbuddy-reviewer: tab type',
  )
  ctx.effect(
    ...
    'dsh-devbuddy-reviewer: tab body',
  )
}
