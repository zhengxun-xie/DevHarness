...
/**
 * DevBuddy Reviewer standalone plugin build — two artifacts from one tsdown
 * invocation, same dual-face pattern as dsh-devbuddy-left:
 *
 *   1. lib/index.js  — Node ESM host half (registered via cordis.patch.yml).
 *      Serves /api/devbuddy/* loopback JSON routes; no runtime npm deps.
...
const PLUGIN_ID = 'dsh-devbuddy-reviewer'
